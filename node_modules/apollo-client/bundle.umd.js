(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-utilities'), require('apollo-link'), require('symbol-observable'), require('apollo-link-dedup')) :
    typeof define === 'function' && define.amd ? define(['exports', 'apollo-utilities', 'apollo-link', 'symbol-observable', 'apollo-link-dedup'], factory) :
    (global = global || self, factory((global.apollo = global.apollo || {}, global.apollo.core = {}), global.apollo.utilities, global.apolloLink.core, global.$$observable, global.apolloLink.dedup));
}(this, function (exports, apolloUtilities, apolloLink, $$observable, apolloLinkDedup) { 'use strict';
    ...
    var QueryStore = (function () {
        ...
        QueryStore.prototype.reset = function (observableQueryIds) {
            ...
            this.store = Object.keys(this.store)
                ...
                res[key] = __assign({}, _this.store[key], { networkStatus: exports.NetworkStatus.loading });
                return res;
            }, {});
        };
        return QueryStore;
